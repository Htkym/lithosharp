...
using PageSharp.Search;
using PageSharp.Validation;
using Markdig;
...
public sealed class SiteGenerator
{
    ...
    {
        var css = BuildBaseCss().Replace("__PAGESHARP_BRAND_PREFIX__", configuration.Theme.BrandPrefix, StringComparison.Ordinal);
    ...
    private static string BuildBaseCss() => """
        ...
        @layer components {
          ...
          .brand::before { content: "__PAGESHARP_BRAND_PREFIX__"; color: var(--accent); }
          .site-home-link,
    ...
    private static string BuildSearchScript(SiteText text)
    {
        ...
        return SearchScriptTemplate.Replace("__PAGESHARP_SEARCH_MESSAGES__", SerializeSearchMessages(messages), StringComparison.Ordinal);
    }
    ...
    private const string SearchScriptTemplate = """
        (() => {
          ...
          const MESSAGES = __PAGESHARP_SEARCH_MESSAGES__;
