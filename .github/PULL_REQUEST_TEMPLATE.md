...
<!--
Does this change affect the bytes of the generated site (templates, encoding,
line endings, target framework)? If so, describe the impact. If not, write "No change".
-->
