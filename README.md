...
[![build](https://github.com/Htkym/pagesharp/actions/workflows/build.yml/badge.svg)](https://github.com/Htkym/pagesharp/actions/workflows/build.yml)
[![NuGet](https://img.shields.io/nuget/v/PageSharp.svg)](https://www.nuget.org/packages/PageSharp)
...
PageSharp is designed to be embedded in your own console app or build pipeline.
...
```powershell
dotnet add package PageSharp
```

PageSharp targets `net10.0` and depends on Markdig, YamlDotNet, and SkiaSharp.
...
{
    Title = "My Site",
    Description = "A static site generated with PageSharp.",
...
A runnable version of this lives in [`samples/PageSharp.Sample`](samples/PageSharp.Sample).
...
`SiteCustomization` is the one-way extension point. PageSharp never references your
...
Namespaces: `PageSharp`, `PageSharp.Configuration`, `PageSharp.Content`,
`PageSharp.Validation`, `PageSharp.Search`.
...
PageSharp follows SemVer. While the version is `0.x`, the public API may change.
